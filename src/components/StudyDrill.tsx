...
/**
 * The quiz session from the former /study route, now run in-page from the
 * vocabulary page. `initialScope` preselects the deck ("all" spans every book,
 * otherwise a bookId); `onExit` returns to the vocabulary lists.
 */
export function StudyDrill({
  initialScope,
  onExit,
}: {
  initialScope: string;
